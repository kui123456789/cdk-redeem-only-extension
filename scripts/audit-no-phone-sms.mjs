...
const PHONE_SMS_PATTERNS = [
  ...
  { label: 'post-login phone verification command', pattern: /post-login-phone-verification/ },
  ...
  { label: 'phone signup method branch', pattern: /\bsignupMethod\b\s*={2,3}\s*['"]phone['"]|\bsignupMethod\b.{0,80}['"]phone['"]|['"]phone['"].{0,80}\bsignupMethod\b/ },
