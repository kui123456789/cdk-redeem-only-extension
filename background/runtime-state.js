(function attachBackgroundRuntimeState(root, factory) {
  ...
  function createRuntimeStateHelpers(deps = {}) {
    ...
    const OPENAI_FLOW_FIELD_GROUPS = Object.freeze({
      ...
      plus: Object.freeze([
        'chatgptSessionReaderTabId',
        'chatgptSessionReaderUrl',
        'chatgptSessionReaderCountry',
        'chatgptSessionReaderCurrency',
        'chatgptSessionReaderSource',
        'plusBillingCountryText',
        'plusBillingAddress',
        'plusLegacyWalletApprovedAt',
        'plusLegacyPayApprovedAt',
        'plusReturnUrl',
        ...
        'legacyPayHelperApiInputWaitSeconds',
        'legacyPayHelperLastInputError',
        'legacyPayHelperOtpInvalidCount',
        'legacyPayHelperFailureStage',
        'legacyPayHelperFailureDetail',
        'legacyPayHelperTaskPayload',
        'legacyPayHelperOrderCreatedAt',
        'legacyPayHelperTaskProgressSignature',
        'legacyPayHelperTaskProgressAt',
        'legacyPayHelperTaskProgressTaskId',
        'legacyPayHelperPinPayload',
